    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h3 class="mt-5">Edit Distribution Centers</h3>
          <br />
          <form method="post" action="changedistribution.php">
            <table class="table col-lg-8">
              <?
                $stmt = $pdo->query('SELECT * FROM donationdropoff WHERE id="'.$id.'"');
                while ($row = $stmt->fetch())
                {
                    ...
                    <tr><td><label>Items Available</label></td><td><input type=\"text\" name=\"items\" value=\"".$row['items']."\"></td></tr>
                    <tr><td><label>Items Needed</label></td><td><input type=\"text\" name=\"itemsneeded\" value=\"".$row['itemsneeded']."\"></td></tr>
